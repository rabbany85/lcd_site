    ...
    <div class="hpanel">
        <div class="panel-body">
            ...
            <h2 class="font-light m-b-xs">
                Please insert client's full details. Once the client is created, the client will have access to the system straight away.
            </h2>
            <small>Add Client Information</small>
        </div>
    </div>
</div>
...
<div class="panel-body p-xl">
    <div class="table-responsive m-t">
        <div class="row">
             ...
             <form method="POST" class="form-horizontal" action="{{route('client.new')}}">
                   {{ csrf_field() }}
                   <div class="col-lg-12">
                        <div class="hpanel">
                             <div class="panel-body">
