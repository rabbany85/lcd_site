    ...
    <div class="hpanel">
        <div class="panel-body">
            ...
            <h2 class="font-light m-b-xs">
                Please insert manager's full details. Once the manager is created, the manager will have access to the system straight away.
            </h2>
            <small>Add Manager Information</small>
        </div>
    </div>
</div>
...
<div class="panel-body p-xl">
    <div class="table-responsive m-t">
        <div class="row">
             ...
             <form method="POST" class="form-horizontal" action="{{route('manager.new')}}">
                   {{ csrf_field() }}
                   <div class="col-lg-12">
                        <div class="hpanel">
                             <div class="panel-body">
